...
objFile.WriteLine Now & " - ORDINI import start"
...
Set ws_DB = objWorkbook_DB.Sheets(2) ' Select Sheet 2 - Ordini
...
Set objWorkbook = objExcel.Workbooks.Open("Z:\Giobby\Export\Ordini\DB_ORDINI.xlsx")
...
For i = 2 To lastUsedRow
    ...
    If id <> "" Then
        url = "http://192.168.100.170:3000/order/" & id & "/costoSpedizione"
...
' Paste values into DB - Copia.xlsx starting at row 2
ws_DB.Range("A2").PasteSpecial -4163 ' xlPasteValues equivalent

'MsgBox amountElements & " elements pasted in DB"
objFile.WriteLine Now & " - ORDINI " & amountElements & " elements pasted in DB"

' Clear clipboard
objExcel.CutCopyMode = False

' Save and close DB_ORDINI.xlsx after manipulation
objWorkbook.Save
...
' Log the update
objFile.WriteLine Now & " - ORDINI import completed"
